...
function absenPiket(
  ...
  navigator.geolocation.getCurrentPosition(
    ...
    function(position) {
      ...
      // ------------------------------------------------------
      //
      // 0 - 20 meter  = radius utama
      // 20 - 40 meter = toleransi
      // > 40 meter    = ditolak
      //
      // ------------------------------------------------------
      ...
      if (
        ...
        tampilkanPesan(
          ...
          "Absensi ditolak karena melebihi batas maksimal " +
          BATAS_MAKSIMAL_METER +
          " meter.",
      ...
      tampilkanPesan(
        ...
        "⏳ Lokasi sesuai batas maksimal. Menyimpan absensi...",
